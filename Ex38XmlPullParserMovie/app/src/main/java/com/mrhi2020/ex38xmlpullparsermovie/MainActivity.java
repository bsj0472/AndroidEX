package com.mrhi2020.ex38xmlpullparsermovie;
...
public class MainActivity extends AppCompatActivity {
    ...
    String apiKey="179528d72532655435357de935e860d3";
    ...
    public void clickBtn(View view) {
        ...
        Thread t= new Thread(){
            ...
            public void run() {
                ...
                //이 앱을 실행하는 날짜의 하루전...
                Date date= new Date();//현재날짜를 가진 객체
                date.setTime( date.getTime() - (1000*60*60*24)  );//1일전
                //현재시간을 "yyyymmdd" 이 형태의 문자열로 만들어야 함.
                //현재시간을 특정 포멧형식모양으로 만들어주는 클래스객체
                SimpleDateFormat sdf= new SimpleDateFormat("yyyyMMdd");
                String dateStr= sdf.format(date) ;

                //api28버전 디바이스 부터는 https가 아닌 http주소를 사용하려면..
                //AndroidManifest.xml에 http를 사용한다고 설정해야함.
